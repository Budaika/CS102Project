...
public class UserDisplay implements UserDisplayInterface {
    ...
    public void welcome() {
        System.out.println("Welcome User!\nIn this application you will have \n"
                + "access to a databasepackage cs102project.core;
...
public class UserDisplay implements UserDisplayInterface {
    ...
    public void displayHottestTemperature() {
        ...
        System.out.printf("Riyadh: %.1f\n", reader.hottestTemperature(d1, d2).get("Riyadh"));
        System.out.printf("Makkah: %.1f\n", reader.hottestTemperature(d1, d2).get("Makkah"));
        System.out.printf("Madina: %.1f\n", reader.hottestTemperature(d1, d2).get("Madinah"));
        System.out.printf("Jeddah: %.1f\n", reader.hottestTemperature(d1, d2).get("Jeddah"));
        System.out.printf("Abha: %.1f\n", reader.hottestTemperature(d1, d2).get("Abha"));
    ...
    public void displayAverageMeasurements() {
        ...
        if (city.equalsIgnoreCase("riyadh") || city.equalsIgnoreCase("makkah")
            ...
            System.out.printf("Average Temperature: %.1f\n", reader.averageMeasurements(new City(city), d1, d2).get("Average Temperature"));
            System.out.printf("Average Humidity: %.1f\n", reader.averageMeasurements(new City(city), d1, d2).get("Average Humidity"));
            System.out.printf("Average Pressure: %.1f\n", reader.averageMeasurements(new City(city), d1, d2).get("Average Pressure"));
            System.out.printf("Average Distance: %.1f\n", reader.averageMeasurements(new City(city), d1, d2).get("Average Distance"));
        } else {
            throw new IllegalArgumentException("wrong input");
        }
    ...
    public void displayCitiesByTemperature() {
        ...
        System.out.println("");
        int i = 1;
        ArrayList<City> citySet = reader.citiesByTemperature(d1, d2);
        for (City city : citySet) {
            System.out.print(i + ". " + city.getCityName() + " Average temperature: ");
                    System.out.printf("%.1f C\n", city.getTemperatureSensor().getAverageValue());
            i++;
 ...
 of different cities and their details\n"
                + "related to Temperature, Pressure, Humidity and Distance. ");
        System.out.println("\nWould you like to see the Main Menu?");
        String userInput = input.nextLine();
        if (userInput.equalsIgnoreCase("yes") || userInput.equalsIgnoreCase("y")) {
